    ...
    <Layout home>
      ...
      <section className={`${utilStyles.headingMd}`}>
        <p className={utilStyles.topP}>
            ...
            <span className={utilStyles.spanTop}>I'm actively exploring back-end & full-stack site engineering opportunities, with a preference for Rails positions. My resume is accessible <a href="/resume">here</a>. You can reach me via email at <a href="mailto:pmk@khot.us">pmk@khot.us</a>.</span>
        </p>
      </section>
