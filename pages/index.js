    ...
    <Layout home>
      ...
      <section className={`${utilStyles.headingMd}`}>
        <p className={utilStyles.topP}>
            Hi. My name is Pascal. I’m a Senior Software Engineer located in San Francisco, CA, USA. My resume can be downloaded <a href="/resume.pdf">here</a>. You can reach me via email at <a href="mailto:pascalm@khot.us">pascalm@khot.us</a>.
        </p>
      </section>
